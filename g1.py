...
#CONFIGURE ODRIVE SETTINGS HERE SO THAT IT DOESN'T RECONFIGURE EVERY LOOP

#set motor calibration time variable??
motor_calibration_time = 6
encoder_calibration_time = 12

#search for connected odrive and assign variable name
